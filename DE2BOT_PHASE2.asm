...
WaitForUser:
	...
	JNEG   Main		   ; Go to main routine if KEY3 is pressed
	IN	   XIO
	AND    Mask1	   ; KEY2 mask
	JNEG   PID_Tuning  ; Go into PID_Tuning if KEY2 is pressed
	JUMP   WaitForUser
...
PID_Tuning:
	...
	IN		XIO
	AND 	Mask0 
	JNEG	WaitForUser	; Exit PID_TUNING if KEY1 is pressed
